...
const About = () => {
  return (
    <div className="bg-slate-50 w-full px-3 pb-20">
      <h1 className="pt-20 text-3xl text-center font-semibold">ABOUT ME</h1>
      ...
      <div>
        <div>
          <div className="px-2">
            <h3 className="mt-16  font-bold text-xl">GET TO KNOW ME</h3>
            ...
            <p className="mt-3 text-slate-600">
              ...
              verticals. Feel free to <span>contact</span> me here
            </p>
            <button className="bg-violet-400 text-white font-medium mt-10 px-7 py-3 rounded tracking-wider shadow-lg hover:bg-gradient-to-b hover:from-violet-400 hover:to-violet-600 transform transition active:translate-y-1 active:duration-75 ease-in-out">
              Contact
            </button>
          </div>
        </div>
